...
const SideBar = (props) => {
    return (
        <div className='sidebar w-[30%] max-md:w-full h-full max-md:h-[20%] max-md:p-4 bg-indigo-600 rounded-[15px] overflow-hidden pl-[50px] pt-[55px] flex flex-col max-md:flex-row max-md:justify-center gap-10 max-sm:gap-5 max-sm:h-[100px] max-sm:p-2'>
